class PagofacilOrder
  ...
  # @option opts [String] :notify_url La dirección del web-service que utilizará pagofacil para notificar cuando el pago esté conciliado
  ...
  # @option opts [String] :responsible_user_email Correo electrónico del responsable de este cobro, debe corresponder a un usuario pagofacil con permisos para cobrar usando esta cuenta de cobro
  ...
  def self.options(order, payment_id, order_url, notify_url, cancel_url)
...

    {
      ...
      notify_url: notify_url, # La dirección del web-service que utilizará pagofacil para notificar cuando el pago esté conciliado
