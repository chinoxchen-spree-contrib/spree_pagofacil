...
require 'spree_pagofacil/version'

Gem::Specification.new do |spec|
  spec.platform      = Gem::Platform::RUBY
  spec.name          = 'spree_pagofacil'
  spec.version       = SpreePagofacil::VERSION
  spec.authors       = ['chinoxchen']
  spec.email         = ['chienfu.udp@gmail.com']

  spec.summary       = 'Spree integration with Pagofacil'
  spec.description   = 'Spree integration with Pagofacil'
  spec.homepage      = 'https://github.com/chinoxchen/spree_pagofacil'
  spec.license       = 'MIT'
